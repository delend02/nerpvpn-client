				...
				faq: [
					{
						...
						answer: 'VPN позволяет подключаться к интернету без ограничений и квот.',
					},
					{
						question: 'Как работает VPN?',
						answer:
							'VPN работает на мобильных устройствах, планшетах, ПК, телевизорах, игровых консолях и многом другом.',
					},
					{
						question: 'Могу ли я использовать VPN на всех устройствах?',
						answer: 'Да, VPN можно использовать на всех ваших устройствах.',
					},
					{
						question: 'Надёжен ли VPN?',
						answer: 'Да, VPN — это надёжный и безопасный сервис.',
					},
					{
						question: 'Как подключиться к VPN?',
						answer: 'Вы можете подключиться к VPN с помощью нашего Telegram-бота.',
					},
					{
						question: 'Могу ли я отменить подписку в любое время?',
						answer: 'Да, вы можете отменить подписку в любой момент.',
					},
					{
						question: 'Сколько стоит VPN?',
						answer: 'Стоимость зависит от выбранного вами тарифа.',
					},
				],
			},
		},
